    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F8F9FF] px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#1a1a2e]">{t('loginTitle')}</h1>
          <p className="text-[#4a4a6a] mt-2">{t('loginSubtitle')}</p>
        </div>

        <div className="bg-white border border-[#E0E0F0] rounded-2xl p-8 shadow-[0_2px_20px_rgba(83,74,183,0.1)]">
          <h2 className="text-xl font-semibold text-[#1a1a2e] mb-6">{t('loginHeading')}</h2>
